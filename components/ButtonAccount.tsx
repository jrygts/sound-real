...
//  1. Dashboard: quick access to the main dashboard
//  2. Billing: open a Stripe Customer Portal to manage their billing (cancel subscription, update payment method, etc.).
